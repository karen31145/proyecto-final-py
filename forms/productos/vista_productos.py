...
class FormProductosVista(tk.Frame):
    def __init__(self, parent):
        ...
        # frame_agregar_inf
        frame_agregar_inf = tk.Frame(frame_agregar,height=100, bd=0, relief=tk.SOLID,bg='yellow')
        frame_agregar_inf.pack(side="bottom",expand=tk.YES,fill=tk.BOTH)

        # frame_agregar_inf_two
        frame_agregar_inf_two = tk.Frame(frame_agregar,height=100, bd=0, relief=tk.SOLID,bg='red')
        frame_agregar_inf_two.pack(side="bottom",expand=tk.YES,fill=tk.BOTH)
