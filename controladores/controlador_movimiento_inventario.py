...
from persistence.modelo_movimiento_inventarios import MovimientoInvenarioModelo
from typing import List
from sqlalchemy.orm.exc import NoResultFound
from sqlalchemy.exc import IntegrityError


class ControladorMovimientoInventarioRepository():
    def __init__(self):
    ...
    def register(self,id_producto,,telefono,email,direccion,indicador_habilitado):
        movimiento_inventario=MovimientoInvenarioModelo()
        proveedor.id_producto=id
